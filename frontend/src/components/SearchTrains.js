  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.formGroup}>
        ...
        <select value={fromStation} onChange={(e) => setFromStation(e.target.value)} style={styles.select}>
      ...
      <div style={styles.formGroup}>
        ...
        <select value={toStation} onChange={(e) => setToStation(e.target.value)} style={styles.select}>
          <option value="">Select Station</option>
          {stations.map(station => (
            <option key={station.StationID} value={station.StationID}>
              {station.name}
      ...
      {trains.length > 0 ? (
        ...
        <p style={styles.noTrainsMessage}>No trains found for the selected route.</p>
      )}
    </div>
  );
};
